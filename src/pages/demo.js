...
export default function Demo() {
  ...
  const simulateDownload = () => {
    const content = `SmartScribe demo placeholder file
This is a simulated .apk for demo purposes.
Replace with real APK file link when ready.`;
    ...
    a.href = url;
    a.download = "smartscribe-demo.apk";
    a.click();
          ...
          <div className="relative bg-gradient-to-br from-indigo-50 to-white rounded-3xl p-12 border-2 border-indigo-100 shadow-xl overflow-hidden">
            ...
            <div className="text-center mb-12 relative z-10">
              ...
              <button
                ...
                className="bg-indigo-600 hover:bg-indigo-700 text-white px-10 py-5 rounded-xl font-bold text-lg shadow-xl hover:shadow-2xl transition-all duration-200 transform hover:scale-105 inline-flex items-center gap-3"
              >
