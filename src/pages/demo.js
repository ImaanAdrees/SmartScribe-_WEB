    ...
    const fetchLatestAPK = async () => {
      try {
        ...
        const res = await axios.get(
          `${API_URL}/api/maintenance/public-apk-history`,
        );
  ...
  const handleDownload = async () => {
    if (latestAPK && latestAPK.filePath) {
      try {
        ...
        link.setAttribute(
          "download",
          `smartscribe-app(${latestAPK.version}).apk`,
        );
        ...
        <section className="relative bg-gradient-to-br from-indigo-600 to-indigo-700 py-20 px-4 overflow-hidden">
          ...
          <div className="max-w-5xl mx-auto text-center relative z-10">
            ...
            <p className="text-xl text-indigo-100 max-w-3xl mx-auto leading-relaxed animate-fade-in-delay">
              Try our demo app and see how SmartScribe transforms your meeting
              experience with intelligent transcription and summaries.
            </p>
          </div>
          ...
          <div className="relative bg-gradient-to-br from-indigo-50 to-white rounded-3xl p-12 border-2 border-indigo-100 shadow-xl overflow-hidden">
            ...
            <div className="text-center mb-12 relative z-10">
              ...
              <h2 className="text-4xl font-bold text-gray-900 mb-4">
                Download the App{" "}
                {latestAPK && (
                  <span className="text-indigo-600 block text-2xl mt-2">
                    v{latestAPK.version}
                  </span>
                )}
              </h2>
              <p className="text-xl text-gray-600 max-w-2xl mx-auto mb-10 leading-relaxed">
                Get started with SmartScribe on your Android device. Record,
                transcribe, and summarize meetings on the go.
              </p>
              <button
            ...
            {latestAPK ? (
              <div className="grid md:grid-cols-3 gap-6 mt-16 relative z-10">
                ...
                {latestAPK.features && latestAPK.features.length > 0 && (
                  <div
                    className={`text-left p-6 bg-white rounded-2xl border border-indigo-100 hover:shadow-lg transition-shadow ${isOnlyFeatures ? "md:col-span-3" : ""}`}
                  >
                ...
                {/* Improvements */}
                {latestAPK.improvements &&
                  latestAPK.improvements.length > 0 && (
              ...
              <div className="grid md:grid-cols-3 gap-6 mt-16 relative z-10">
                <div className="text-center p-6 bg-white rounded-2xl border border-indigo-100">
                  ...
                  <p className="text-gray-600 text-sm">
                    Install and start recording in seconds
                  </p>
                </div>
                <div className="text-center p-6 bg-white rounded-2xl border border-indigo-100">
                  <div className="w-12 h-12 bg-indigo-100 rounded-xl flex items-center justify-center mx-auto mb-4">
                ...
                <div className="text-center p-6 bg-white rounded-2xl border border-indigo-100">
                  ...
                  <p className="text-gray-600 text-sm">
                    Access all SmartScribe capabilities
                  </p>
                </div>
              </div>
            )}
            ...
            <div className="mt-12 bg-white rounded-2xl p-8 border-2 border-gray-100">
              ...
              <div className="grid md:grid-cols-2 gap-6">
                {apkInfo.slice(1).map((release, index) => (
                  <div
                    key={index}
                    className="p-6 bg-gray-50 rounded-xl border border-gray-200 hover:border-indigo-300 transition-colors"
                  >
                      ...
                      <div className="mt-3">
                        ...
                        <ul className="space-y-1">
                          ...
                          {release.features.length > 3 && (
                            <li className="text-xs text-indigo-500 mt-1 ml-3">
      ...
      >
        <div className="text-center">
          ...
          <div className="bg-gray-100 p-4 rounded-lg mb-4">
            <h4 className="font-bold text-xl text-indigo-600">
              SmartScribe App
            </h4>
