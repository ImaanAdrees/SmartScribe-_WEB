  ...
  const fetchRecipientCount = async (audience, userIds) => {
    ...
    try {
      ...
      const { data } = await axios.get(
        `${API_URL}/api/notifications/recipients?${params.toString()}`,
        {
          headers: {
            Authorization: `Bearer ${token}`,
          },
      ...
      <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 mb-6">
        <div>
          ...
          <p className="text-gray-600 mt-1">
            Broadcast messages to users about updates and changes
          </p>
        </div>
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-green-700">
                  {successMessage || "Your notification was processed."}
                </p>
              </div>
            </div>
            <button
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="space-y-6">
            ...
            <div className="bg-white rounded-2xl border border-gray-200 p-6 w-full overflow-x-auto">
              ...
              <div
                className={`p-4 rounded-xl border-2 ${getTypeColor(notificationType).bg} border-${notificationType === "success" ? "green" : notificationType === "warning" ? "yellow" : notificationType === "alert" ? "red" : "blue"}-200`}
              >
                <div className="flex items-start gap-3">
                  <div
                    className={`w-10 h-10 rounded-full flex items-center justify-center flex-shrink-0 ${notificationType === "success" ? "bg-green-100" : notificationType === "warning" ? "bg-yellow-100" : notificationType === "alert" ? "bg-red-100" : "bg-blue-100"}`}
                  >
                    ...
                    notifications.map((notif) => (
                      ...
                      >
                        ...
                        <td className="px-4 py-2">
                          {notif.audienceLabel || notif.audience}
                        </td>
                        ...
                        <td className="px-4 py-2">
                          <span
                            className={`px-3 py-1 rounded-full text-xs font-semibold ${getTypeColor(notif.type).bg} ${getTypeColor(notif.type).text}`}
                          >
                            {notif.status}
                          </span>
                        </td>
