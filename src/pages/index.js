      ...
      <main className="bg-white">
        ...
        <section className="bg-gradient-to-br from-indigo-50 to-white py-20 px-4">
          <div className="max-w-6xl mx-auto text-center">
            <div className="inline-block px-4 py-2 bg-indigo-100 rounded-full text-indigo-600 text-sm font-semibold mb-6 animate-slide-up">
              AI-Powered Meeting Assistant
            </div>
            <h1 className="text-5xl md:text-6xl font-bold text-gray-900 mb-6 leading-tight animate-slide-up anim-delay-100">
